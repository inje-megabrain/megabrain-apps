...
import { NEXT_PUBLIC_ROOT_URL } from '~/constants/public';

// !STARTERCONF Change these default meta
const defaultMeta = {
  title: 'Megabrain 메가브레인 - 새로운 웹 개발을 위한 동아리',
  siteName: 'Megabrain 메가브레인',
  description:
    '웹, 앱 등 새로운 서비스 개발을 위한 연구, 개발, 학습을 하는 인제대학교 동아리입니다.',
  url: NEXT_PUBLIC_ROOT_URL,
  type: 'website',
  robots: 'follow, index',
  tag: 'Megabrain, 메가브레인, 인제대학교, 동아리, 개발, 웹, 앱, 서비스, 연구, 학습',
  /**
   * No need to be filled, will be populated with openGraph function
   * If you wish to use a normal image, just specify the path below
   */
  image: NEXT_PUBLIC_ROOT_URL + '/large-og.jpg',
  themeColor: '#FFFFFF',
};
